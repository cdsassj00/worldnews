...
const STEPS: TourStep[] = [
  ...
  {
    // 페이지에 처음부터 있는 정적 블록을 잡는다 — 카드(#hz-body)는 비동기라
    // 투어가 먼저 돌면 선택자가 안 맞아 이 단계가 통째로 건너뛰어진다.
    sel: ".picks-head",
    title: "① 오늘의 추천 — 여기부터 보세요",
    body: "단타·스윙·중기·장기 네 구간으로 나눠 지금 살 종목을 고릅니다. 구간마다 목표가·손절가를 숫자로 박아 두고, 그 규칙이 과거에 지수 대비 어땠는지를 3개월·6개월·1년 세 창으로 같이 보여 줍니다.",
  },
  {
